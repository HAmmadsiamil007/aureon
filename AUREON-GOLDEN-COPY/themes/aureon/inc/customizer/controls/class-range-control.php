...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Aureon_Range_Slider_Control' ) ) {
	/**
	 ...
	 * @since 1.3.47
	 */
	class Aureon_Range_Slider_Control extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		 * @var string
		 */
		public $type = 'aureon-range-slider';
		...
		public function to_json() {
			...
			$this->json['desktop_label'] = __( 'Desktop', 'aureon' );
			$this->json['tablet_label'] = __( 'Tablet', 'aureon' );
			$this->json['mobile_label'] = __( 'Mobile', 'aureon' );
			$this->json['reset_label'] = __( 'Reset', 'aureon' );
