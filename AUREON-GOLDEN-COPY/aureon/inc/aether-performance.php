...
function aether_preload_assets() {
	...
	$fonts_url = trailingslashit( get_template_directory_uri() ) . 'frontend/assets/css/fonts.css';
	if ( file_exists( get_template_directory() . '/frontend/assets/css/fonts.css' ) ) {
		$fonts_url = add_query_arg( 'ver', filemtime( get_template_directory() . '/frontend/assets/css/fonts.css' ), $fonts_url );
	}
