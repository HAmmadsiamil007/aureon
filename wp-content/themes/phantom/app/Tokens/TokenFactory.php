 ...
 * CSS variable assignments: token 'color.bg' with scope 'phantom' →
 * '--phantom-color-bg'. Scope defaults to the project prefix (ADR-002).
 *
...
final class TokenFactory {
	 ...
	 */
	public function to_css_map( array $resolved, string $scope = 'phantom' ): array {
		$map = array();
	 ...
	 * @return string
	 */
	public function var_name( string $token, string $scope = 'phantom' ): string {
