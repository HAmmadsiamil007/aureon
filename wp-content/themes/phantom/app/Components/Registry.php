...
class Registry {
	...
	/**
	 * Shortcode DSL prefix: components render as `[phantom:{slug}]` (plan §Phase 5).
	 *
	 * @var string
	 */
	public const SHORTCODE_PREFIX = 'phantom:';
	...
	/**
	 * Shortcode tag → component name map (the public `[phantom:{slug}]` DSL).
	 *
	...
	/**
	 * Render through the public `[phantom:{slug}]` shortcode DSL.
	 *
	 ...
	 *
	 * @param string               $tag    Shortcode tag (e.g. 'phantom:button').
