<?php
/**
 * FAQ — FAQ page template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('faq-page', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'faq-page', apply_filters( 'phantom_template_data', array(), 'faq-page' ) );
