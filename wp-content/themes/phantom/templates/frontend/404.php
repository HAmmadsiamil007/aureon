<?php
/**
 * 404 — not-found template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('not-found', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'not-found', apply_filters( 'phantom_template_data', array(), 'not-found' ) );
