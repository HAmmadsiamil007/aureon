<?php
/**
 * Landing — landing page template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('landing', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'landing', apply_filters( 'phantom_template_data', array(), 'landing' ) );
