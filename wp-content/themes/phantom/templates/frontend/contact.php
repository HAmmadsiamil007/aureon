<?php
/**
 * Contact — contact page template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('contact', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'contact', apply_filters( 'phantom_template_data', array(), 'contact' ) );
