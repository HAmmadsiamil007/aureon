<?php
/**
 * Blog — blog index template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('blog', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'blog', apply_filters( 'phantom_template_data', array(), 'blog' ) );
