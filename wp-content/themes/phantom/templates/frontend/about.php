<?php
/**
 * About — about page template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('about', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'about', apply_filters( 'phantom_template_data', array(), 'about' ) );
