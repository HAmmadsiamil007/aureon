<?php
/**
 * Author — author archive template (Phase 12).
 *
 * Thin WordPress template: all composition is delegated to the registry via
 * Templates\View::compose('author', $data). No markup, no business logic.
 *
...
echo \Phantom\Core\Templates\View::compose( 'author', apply_filters( 'phantom_template_data', array(), 'author' ) );
