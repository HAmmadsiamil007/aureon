<?php
/**
 * Thank-you — order received template (Phase 12).
 *
 * Thin WordPress template: composition is delegated to the registry. Order
...
echo \Phantom\Core\Templates\View::compose( 'thank-you', apply_filters( 'phantom_template_data', array(), 'thank-you' ) );
