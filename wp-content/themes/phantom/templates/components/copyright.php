...
?>
<div class="phantom-copyright">
	<?php if ( $view->prop( 'text' ) ) : ?>
		<p class="phantom-copyright__text"><?php echo $view->e( $view->prop( 'text' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- escaped by ViewContext::e(). ?></p>
	<?php endif; ?>
	<?php if ( $view->prop( 'links' ) ) : ?>
		<ul class="phantom-copyright__links">
			<?php foreach ( (array) $view->prop( 'links', array() ) as $link ) : ?>
				<li class="phantom-copyright__link">
