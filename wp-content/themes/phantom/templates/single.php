 ...
 *
 * Composes the page from public GeneratePress/WordPress APIs (get_header,
 * get_footer, comments_template) and the Phantom framework (View::partial for
...
get_header();
?>
<main id="primary" class="phantom-main site-main">
	<?php
	while ( have_posts() ) :
		the_post();
		...
		echo \Phantom\Core\Templates\View::partial( 'content-single', array() );
	...
	echo \Phantom\Core\Templates\View::section( 'after-main' );
	?>
</main>
<?php
get_footer();
