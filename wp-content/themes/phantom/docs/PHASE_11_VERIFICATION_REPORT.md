...
| Token-driven (no hardcoded values)                   | `_components.scss` regex check: 0 raw hex, >50 `var(--phantom-*)`         |
| Animation-ready                                      | `data-phantom-anim="reveal"` on hero/cta/testimonials; count/sticky hooks |
