# FINAL RISK REGISTER — Phantom Theme / Phantom Core
...
- **Update safety (ADR-004):** parent integrity gate 473/473; if GeneratePress
  or GP Premium ships a future update, the gate detects drift before release.
