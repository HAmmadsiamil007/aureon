...
| 5     | Component Registry | `v0.5.0-components` | 38/38 | `app/Components/*`, JSON discovery, `[phantom:{slug}]` DSL                      |
...
- Every subsystem is a **service provider** registered in `Config\config.php`
  `providers`, behind feature flags (`phantom_core`, `render_engine`,
