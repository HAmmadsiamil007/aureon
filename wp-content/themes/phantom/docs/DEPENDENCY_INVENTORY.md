# DEPENDENCY INVENTORY — Phantom Theme / Phantom Core
...
| GeneratePress | 3.6.1     | Parent theme (untouched, 473/473)                     |
| GP Premium    | 2.5.6     | Parent add-on (untouched, 473/473)                    |
...
| ------------------- | ----- | --------------------------- |
| GeneratePress 3.6.1 | 473   | `gp_audit_manifest_new.txt` |
| GP Premium 2.5.6    | 473   | `gp_audit_manifest_new.txt` |

Verified byte-identical at this freeze (14/14 suites + integrity gate green).
