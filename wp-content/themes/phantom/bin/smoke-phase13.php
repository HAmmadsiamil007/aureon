...
use Phantom\Core\Performance\Budget;
use Phantom\Core\Performance\BudgetLogger;
use Phantom\Core\Performance\CachePurger;
use Phantom\Core\Performance\Lazy;
use Phantom\Core\Performance\QueryGuard;
...
echo "== Phantom Core Phase 13 smoke suite (Performance Engineering) ==\n\n";
...
check( 'Phase 6 regression: composer resolves', $app->make( 'templates.composer' ) instanceof \Phantom\Core\Templates\Composer );
...
check( 'Phase 11 regression: hero renders', str_contains( $app->make( 'components.registry' )->render( 'hero', array( 'title' => 'R' ) ), 'phantom-hero' ) );
