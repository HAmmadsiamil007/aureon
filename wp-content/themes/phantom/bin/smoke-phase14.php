...
use Phantom\Core\A11y\Checker;
use Phantom\Core\A11y\DialogManager;
use Phantom\Core\A11y\SkipLink;
...
echo "== Phantom Core Phase 14 smoke suite (Accessibility Engineering) ==\n\n";
...
check( 'skip link renders', str_contains( $skip, 'class="screen-reader-text phantom-skip-link"' ) );
...
check( 'Phase 13 regression: budget resolves', $app->make( 'performance.budget' ) instanceof \Phantom\Core\Performance\Budget );
