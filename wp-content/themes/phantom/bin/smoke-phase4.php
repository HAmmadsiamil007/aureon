...
use Phantom\Core\Cache\CacheInterface;
use Phantom\Core\Container\Container;
use Phantom\Core\Core\App;
use Phantom\Core\Data\MenuAdapter;
use Phantom\Core\Data\PostAdapter;
use Phantom\Core\Data\SettingsAdapter;
use Phantom\Core\Data\SiteAdapter;
use Phantom\Core\Data\TaxAdapter;
use Phantom\Core\Data\TermAdapter;
use Phantom\Core\Data\UserAdapter;
use Phantom\Core\Data\WpQueryAdapter;
use Phantom\Core\Render\Layout;
use Phantom\Core\Render\PhpTemplateEngine;
use Phantom\Core\Render\RenderCache;
use Phantom\Core\Render\RenderException;
use Phantom\Core\Render\Renderer;
use Phantom\Core\Render\TemplateResolver;
use Phantom\Core\Render\ViewModel;
use Phantom\Core\Render\ViewContext;
...
echo "== Phantom Core Phase 4 smoke suite (Render Engine) ==\n\n";
...
$card_html  = $renderer->render( 'card', array( 'title' => 'Hello Phantom', 'link' => 'https://example.com/p', 'excerpt' => 'A card.' ) );
check( 'render("card") produces HTML', str_contains( $card_html, 'phantom-card' ) && str_contains( $card_html, 'Hello Phantom' ) );
...
check( 'SiteAdapter WP-free defaults', 'Phantom' === ( new SiteAdapter() )->adapt( null )->get( 'name' ) );
...
check( 'Phase 3 regression: tokens repository resolves', $app->make( 'tokens.repository' ) instanceof \Phantom\Core\Tokens\TokenRepository );
