 ...
 * with dot-notation access (log.level, features.lumina_core), all() for bulk
...
final class Repository {
	 ...
	 *
	 * @param string $key      Key, e.g. "log.level" or "features.lumina_core".
	...
	public function set( string $key, mixed $value ): void {
		if ( ! $this->mutable ) {
			throw new \LogicException(
				'Config\\Repository is immutable; overrides belong in lumina.env.json.'
			);
		}
