 ...
 * per-environment overrides from `lumina.env.json` (ADR-011). The result is a
...
namespace Lumina\Core\Config;

/**
 * Loads and merges Lumina configuration.
 */
final class ConfigLoader {
	 ...
	 * @var string
	 */
	private const ENV_FILE = 'lumina.env.json';
	...
	/**
	 * Read and decode the optional lumina.env.json overrides.
	 *
	 * @return array<string, mixed>
	 */
