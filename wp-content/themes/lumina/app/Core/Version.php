<?php
/**
 * Version metadata for the Lumina Core framework.
 *
 ...
 * Engineering; 0.14.0: Accessibility Engineering; 1.0.0: Rebrand to
 * Lumina — standalone theme, original companion plugin)
 */
...
/**
 * Immutable version constants for Lumina Core.
 *
...
final class Version {
	...
	/**
	 * Namespace root for all Lumina Core code (ADR-002).
	 *
	 * @var string
	 */
	public const NAMESPACE_ROOT = 'Lumina\\Core\\';
	 ...
	 * @var string
	 */
	public const HANDLE_PREFIX = 'lumina-';
}
