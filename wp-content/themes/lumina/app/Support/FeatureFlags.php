 ...
 * (`lumina_feature_*`, ADR-002). Flags default OFF for unshipped subsystems
 * and ON for complete ones; per-environment toggling happens via
 * lumina.env.json — never edited in code.
 *
...
final class FeatureFlags {
	 ...
	 *
	 * @param string $name Flag name without the lumina_feature_ prefix.
	 * @return bool
	 */
