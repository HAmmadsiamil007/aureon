...
return array(
	...
	// ------------------------------------------------------------------
	// Page header region (Phase 16 — Lumina Companion PageHeader module)
	// ------------------------------------------------------------------
	'page-header' => array(
		'main' => array(
			array(
				...
				'props'     => static fn( array $data ): array => array(
					'title'       => (string) ( $data['title'] ?? $data['page_header']['title'] ?? '' ),
					'description' => (string) ( $data['text'] ?? $data['page_header']['text'] ?? '' ),
				),
			),
		),
	),
