...
?>
<button
	class="lumina-compare-button<?php echo $view->prop( 'active' ) ? ' is-active' : ''; ?>"
	type="button"
...
>
	<span class="lumina-compare-button__icon" aria-hidden="true">&#8645;</span>
	<span class="lumina-compare-button__label"><?php echo $view->e( $view->prop( 'label', 'Compare' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- escaped by ViewContext::e(). ?></span>
</button>
