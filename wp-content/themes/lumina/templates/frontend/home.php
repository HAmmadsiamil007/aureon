 ...
 * hardcoded content — data arrives through the `lumina_template_data` filter.
 *
...
echo \Lumina\Core\Templates\View::compose( 'home', apply_filters( 'lumina_template_data', array(), 'home' ) );
