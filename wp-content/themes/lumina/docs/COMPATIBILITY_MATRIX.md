# COMPATIBILITY MATRIX — Lumina Theme / Lumina Core
...
| Customizer                     | ✅ verified | Lumina-registered settings only; no parent Customizer surface (standalone)                           |
| Menus / Navigation             | ✅ design   | Phase-11 header/nav components consume `Menu` data adapter                                           |
| Widgets                        | ✅ design   | WP widget areas used natively; no interference                                                       |
...
| Shortcodes                     | ✅ verified | `[lumina:{slug}]` DSL (Phase-5 registry, smoke-phase5)                                               |
...
| Theme updates                  | ✅ design   | Standalone theme — no parent update coupling (ADR-004)                                               |
...
| Child-theme compat             | ✅ design   | Lumina is standalone; if used as a parent, no deeper nesting assumptions                             |
...
| Dark mode             | ✅ design   | `[data-lumina-theme="dark"]` preset (tokens)                             |
...
- **Supported floor:** WordPress ≥ 6.5 · PHP ≥ 8.2 (standalone theme — no
  parent theme required).
- **Not supported:** PHP < 8.2 (below declared floor).
- **Never modified:** WordPress Core or any plugin (guarded adapters only).
