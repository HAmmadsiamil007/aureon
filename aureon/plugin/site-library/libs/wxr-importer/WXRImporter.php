...
namespace Aureon\WPContentImporter2;
...
class WXRImporter extends \WP_Importer {
	...
	protected function process_attachment( $post, $meta, $remote_url ) {
		...
		$attachment_metadata = wp_aureon_attachment_metadata( $post_id, $upload['file'] );
