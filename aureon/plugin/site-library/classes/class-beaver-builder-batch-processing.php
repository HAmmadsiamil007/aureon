 ...
 * @since 1.6
 */
class Aureon_Sites_Process_Beaver_Builder {
	...
	public function __construct() {
		$this->image_importer = new Aureon_Sites_Image_Importer();
	}
	...
	public function import() {
		Aureon_Site_Library_Helper::log( '== Start Processing Beaver Builder Images ==' );

		$post_ids = Aureon_Site_Library_Helper::get_all_posts();
