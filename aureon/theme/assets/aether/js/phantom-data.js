...
(function() {
  ...
  function buildProductCard(product) {
    ...
    return '<div class="product-card" data-product-id="' + (product.id || '') + '">' +
      ...
      '<a href="' + sanitizeUrl(product.url || '#') + '" class="btn btn-sm btn-primary add-to-cart-trigger" data-product-id="' + (product.id || '') + '">Add to Cart</a>' +
      '</div></div></div>';
  }
  ...
  function buildPostCard(post) {
    ...
    return '<a href="' + sanitizeUrl(post.url || '#') + '" class="blog-card" data-tilt data-reveal-item>' +
  ...
  // === Init ===
  function init() {
    // Phantom Data Bridge ready — data populated via data-phantom-* attributes.
  }
