...
Aureon is a lightweight WordPress theme built with a focus on speed and usability. Performance is important to us, which is why a fresh Aureon install adds less than 10kb (gzipped) to your page size.

We take full advantage of the block editor (Gutenberg), which gives you more control over creating your content.

If you use page builders, Aureon is the right theme for you. It is completely compatible with all major page builders, including Beaver Builder and Elementor.
...
Aureon is fully responsive, uses valid HTML/CSS, and is translated into over 25 languages by our amazing community of users.
...
Learn more and check out our [powerful premium version](https://aureonstudio.com).
...
= Is Aureon Free? =
Yes! Aureon is a free theme, and always will be.

= Does Aureon have a pro version? =
It does! Aureon has a premium plugin which extends the available options in the theme.

You can learn more about Aureon Studio [here](https://aureonstudio.com/premium).

= Where can I find documentation? =
Aureon has extensive documentation you can find [here](https://docs.aureonstudio.com).

= Do you offer support? =
Definitely. We offer support for the free theme in the [WordPress.org forums](https://wordpress.org/support/theme/aureon).

Premium customers have access to our very own [support forum](https://aureonstudio.com/support).
...
= Does Aureon have any widget areas? =
Aureon has up to 9 widget areas which you can add widgets to in Appearance > Widgets.

= How can I make my site look like your screenshot? =
If you want to replicate the screenshot you see on WordPress.org, please refer to [this article](https://docs.aureonstudio.com/article/replicating-the-screenshot/).

== License ==

Aureon is licensed under the GNU General Public License v2 or later
...
* Fix: PHP 8.1 warning in Aureon_Typography:get_css
...
* Feature: Add aureon_font_manager_show_google_fonts PHP filter
* Feature: Add aureon_font_manager_system_fonts JS filter
* Feature: Add aureon_font_manager_google_fonts JS filter
* Feature: Add aureon_add_comment_date_link PHP filter
...
* Fix: Adjust editor block width selector to fix compatibility with Aureon Studio
...
* New: aureon_has_active_menu filter
* New: aureon_before_loop hook
* New: Dynamic HTML attribute system
* New: React-based Dashboard
* New: aureon_search_title_output filter
* New: aureon_after_comment_author_name hook
* New: aureon_show_comment_entry_meta filter
...
* Tweak: Add search result title using aureon_before_loop hook
...
* Tweak: Move aureon_svg_icon_element before the "replace" icon definition
...
* New: aureon_before_do_template_part hook
* New: aureon_after_do_template_part hook
* New: aureon_do_template_part filter
* New: Better option migration system
* New: aureon_post_date_show_updated_only filter
* New: aureon_navigation_search_menu_item_output filter
* New: style-rtl.min.css and enqueue manually
* New: aureon_load_child_theme_stylesheet filter
* New: aureon_before_navigation hook
* New: aureon_after_navigation hook
* New: aureon_page_class filter
* New: aureon_is_using_hatom filter
* New: aureon_after_element_class_attribute filter
* New: aureon_menu_bar_items hook
* New: aureon_show_entry_header filter
...
* New: aureon_comments_title_output filter
* New: aureon_get_the_title_parameters filter
* New: aureon_has_default_loop filter
* New: aureon_localize_js_args filter
...
* Tweak: Hook comments template into aureon_after_do_template_part
...
* Tweak: Add single post navigation to aureon_footer_entry_items filter
* Tweak: Hook archive post navigation into aureon_after_loop hook
* Tweak: Use aria-label for read more links/buttons instead of screen reader text
* Tweak: Move microdata to aureon_after_element_class_attribute where possible
...
* Template change: Removed aureon_do_microdata() from sidebar.php and sidebar-left.php
* Template changes: Added aureon_do_template_part() to all templates with a loop

= Earlier versions =

For the changelog of earlier versions, please refer to our [development log](https://aureonstudio.com/category/changelog/).
