...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Aureon_Typography_Customize_Control' ) ) {
	/**
	 * Create the typography elements control.
	 *
	 * @since 2.0
	 */
	class Aureon_Typography_Customize_Control extends WP_Customize_Control {
		/**
		 * Set the type.
		 *
		 * @var string $type
		 */
		public $type = 'aureon-customizer-typography';
		...
		public function to_json() {
			...
			$this->json['default_fonts_title'] = __( 'System fonts', 'aureon' );
			$this->json['google_fonts_title'] = __( 'Google fonts', 'aureon' );
			$this->json['default_fonts'] = aureon_typography_default_fonts();
			$this->json['family_title'] = esc_html__( 'Font family', 'aureon' );
			$this->json['weight_title'] = esc_html__( 'Font weight', 'aureon' );
			$this->json['transform_title'] = esc_html__( 'Text transform', 'aureon' );
			$this->json['category_title'] = '';
			$this->json['variant_title'] = esc_html__( 'Variants', 'aureon' );
