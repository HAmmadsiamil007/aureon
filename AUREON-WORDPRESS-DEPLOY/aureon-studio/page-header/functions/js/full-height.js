...
function aureonHeaderHeight() {
	...
	} else if ( jQuery( '.aureon-inside-combined-content' ).length ) {
		page_header_content = jQuery( '.aureon-inside-combined-content' );
	} else {
		page_header_content = jQuery( '.aureon-inside-page-header-content' );
	}
