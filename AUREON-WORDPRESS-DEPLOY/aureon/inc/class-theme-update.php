...
class Aureon_Theme_Update {
	...
	public static function init() {
		...
		$saved_version = get_option( 'aureon_db_version', false );
		...
		if ( false === $saved_version ) {
			...
			if ( ! empty( $existing_settings ) ) {
				...
				if ( 'admin_init' === current_action() ) {
					...
					update_option( 'aureon_db_version', AUREON_VERSION );
				}
		...
		if ( version_compare( $saved_version, AUREON_VERSION, '=' ) ) {
			return;
		}
	...
	public static function v_3_0_0() {
		...
		$spacing_settings = get_option( 'aureon_spacing_settings', array() );
		...
		if ( $update_spacing_options ) {
			update_option( 'aureon_spacing_settings', $spacing_settings );
		}
...
Aureon_Theme_Update::get_instance();
