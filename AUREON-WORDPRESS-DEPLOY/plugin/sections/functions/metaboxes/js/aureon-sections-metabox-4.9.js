...
(function($, Aureon_Sections) {
    ...
    Aureon_Sections.backbone_modal.Application = Backbone.View.extend({
        ...
        tinyMCEsettings: function() {
            ...
            var _this = this;
            var custom_settings = {
                selector: "#aureon-sections-editor",
        ...
        startTinyMCE: function() {
            ...
            this.ui.panels.find("#wp-aureon-sections-editor-wrap").addClass(aureon_sections_metabox_i18n.default_editor);
            ...
            if (typeof tinyMCEPreInit == 'object') {
                tinyMCEPreInit.mceInit["aureon-sections-editor"] = this.tmc_settings;
                tinyMCEPreInit.qtInit["aureon-sections-editor"] = this.qt_settings;
				tinyMCEPreInit.mceInit["aureon-sections-editor"].wp_keep_scroll_position = false;
            }
