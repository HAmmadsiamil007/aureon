 ...
 * @param get_value
 */
function aureon_colors_live_update( id, selector, property, default_value, get_value ) {
	default_value = typeof default_value !== 'undefined' ? default_value : 'initial';
	get_value = typeof get_value !== 'undefined' ? get_value : '';

	wp.customize( 'aureon_settings[' + id + ']', function( value ) {
...
function aureon_classes_live_update( id, classes, selector, prefix ) {
...
function aureon_typography_live_update( id, selector, property, unit, media, settings ) {
		...
		value.bind( function( newval ) {
			...
			if ( ! isTablet && ! isMobile ) {
				...
				if ( '' !== tabletValue && '' == mobileValue ) {
					media = aureon_live_preview.desktop + ', ' + aureon_live_preview.mobile;
				}

				// The tablet setting doesn't exist, mobile does
				if ( '' == tabletValue && '' !== mobileValue ) {
					media = aureon_live_preview.desktop + ', ' + aureon_live_preview.tablet;
				}

				// The tablet setting doesn't exist, neither does mobile
				if ( '' == tabletValue && '' == mobileValue ) {
					media = aureon_live_preview.desktop + ', ' + aureon_live_preview.tablet + ', ' + aureon_live_preview.mobile;
				}
			}
...
( function( $ ) {
	...
	wp.customize( 'aureon_settings[logo_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Container width
	 */
	wp.customize( 'aureon_settings[container_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * We only want to run this if Aureon Studio isn't already doing it.
	 */
	if ( 'undefined' === typeof aureon_studio_typography_live_update ) {
		/**
		 * Body font size, weight and transform
		 */
		aureon_typography_live_update( 'body_font_size', 'body, button, input, select, textarea', 'font-size', 'px' );
		aureon_typography_live_update( 'body_line_height', 'body', 'line-height', '' );
		aureon_typography_live_update( 'paragraph_margin', 'p, .entry-content > [class*="wp-block-"]:not(:last-child)', 'margin-bottom', 'em' );
		aureon_typography_live_update( 'body_font_weight', 'body, button, input, select, textarea', 'font-weight' );
		aureon_typography_live_update( 'body_font_transform', 'body, button, input, select, textarea', 'text-transform' );

		/**
		 * H1 font size, weight and transform
		 */
		aureon_typography_live_update( 'heading_1_font_size', 'h1', 'font-size', 'px', aureon_live_preview.desktop );
		aureon_typography_live_update( 'mobile_heading_1_font_size', 'h1', 'font-size', 'px', aureon_live_preview.mobile );
		aureon_typography_live_update( 'heading_1_weight', 'h1', 'font-weight' );
		aureon_typography_live_update( 'heading_1_transform', 'h1', 'text-transform' );
		aureon_typography_live_update( 'heading_1_line_height', 'h1', 'line-height', 'em' );

		/**
		 * H2 font size, weight and transform
		 */
		aureon_typography_live_update( 'heading_2_font_size', 'h2', 'font-size', 'px', aureon_live_preview.desktop );
		aureon_typography_live_update( 'mobile_heading_2_font_size', 'h2', 'font-size', 'px', aureon_live_preview.mobile );
		aureon_typography_live_update( 'heading_2_weight', 'h2', 'font-weight' );
		aureon_typography_live_update( 'heading_2_transform', 'h2', 'text-transform' );
		aureon_typography_live_update( 'heading_2_line_height', 'h2', 'line-height', 'em' );

		/**
		 * H3 font size, weight and transform
		 */
		aureon_typography_live_update( 'heading_3_font_size', 'h3', 'font-size', 'px' );
		aureon_typography_live_update( 'heading_3_weight', 'h3', 'font-weight' );
		aureon_typography_live_update( 'heading_3_transform', 'h3', 'text-transform' );
		aureon_typography_live_update( 'heading_3_line_height', 'h3', 'line-height', 'em' );
	}

	/**
	 * Top bar width
	 */
	wp.customize( 'aureon_settings[top_bar_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full' == newval ) {
				$( '.top-bar' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'contained' == wp.customize.value( 'aureon_settings[top_bar_inner_width]' )() ) {
	 ...
	 * Inner top bar width
	 */
	wp.customize( 'aureon_settings[top_bar_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full' == newval ) {
				$( '.inside-top-bar' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
			}
	 ...
	 * Top bar alignment
	 */
	aureon_classes_live_update( 'top_bar_alignment', [ 'left', 'center', 'right' ], '.top-bar', 'top-bar-align-' );

	/**
	 * Header layout
	 */
	wp.customize( 'aureon_settings[header_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			if ( 'fluid-header' == newval ) {
				$( '.site-header' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'contained' == wp.customize.value( 'aureon_settings[header_inner_width]' )() ) {
	 ...
	 * Inner Header layout
	 */
	wp.customize( 'aureon_settings[header_inner_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Header alignment
	 */
	aureon_classes_live_update( 'header_alignment_setting', [ 'left', 'center', 'right' ], 'body', 'header-aligned-' );

	/**
	 * Navigation width
	 */
	wp.customize( 'aureon_settings[nav_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			var navLocation = wp.customize.value( 'aureon_settings[nav_position_setting]' )();
			...
			if ( $( 'body' ).hasClass( 'sticky-enabled' ) ) {
				...
				if ( 'fluid-nav' == newval ) {
					...
					if ( 'full-width' !== wp.customize.value( 'aureon_settings[nav_inner_width]' )() ) {
						$( '.main-navigation .inside-navigation' ).addClass( 'grid-container' ).addClass( 'grid-parent' );
					}
				}
				if ( 'contained-nav' == newval ) {
					if ( ! mainNavigation.hasClass( 'has-branding' ) && aureon_live_preview.isFlex && ( 'nav-float-right' === navLocation || 'nav-float-left' === navLocation ) ) {
						return;
					}
	 ...
	 */
	wp.customize( 'aureon_settings[nav_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full-width' == newval ) {
	 ...
	 */
	wp.customize( 'aureon_settings[nav_alignment_setting]', function( value ) {
		value.bind( function( newval ) {
			var classes = [ 'left', 'center', 'right' ];
			var selector = 'body';
			var prefix = 'nav-aligned-';

			if ( aureon_live_preview.isFlex ) {
			...
			if ( aureon_live_preview.isFlex && aureon_live_preview.isRTL ) {
				jQuery( selector ).addClass( prefix + newval );
	 ...
	 * Footer width
	 */
	wp.customize( 'aureon_settings[footer_layout_setting]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Inner footer width
	 */
	wp.customize( 'aureon_settings[footer_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full-width' == newval ) {
	 ...
	 */
	aureon_classes_live_update( 'footer_bar_alignment', [ 'left', 'center', 'right' ], '.site-footer', 'footer-bar-align-' );

	jQuery( 'body' ).on( 'aureon_spacing_updated', function() {
		var containerAlignment = wp.customize( 'aureon_settings[container_alignment]' ).get(),
			containerWidth = wp.customize( 'aureon_settings[container_width]' ).get(),
			containerLayout = wp.customize( 'aureon_settings[content_layout_setting]' ).get(),
			contentLeft = aureon_live_preview.contentLeft,
			contentRight = aureon_live_preview.contentRight;

		if ( ! aureon_live_preview.isFlex && 'text' === containerAlignment ) {
			if ( typeof wp.customize( 'aureon_spacing_settings[content_left]' ) !== 'undefined' ) {
				contentLeft = wp.customize( 'aureon_spacing_settings[content_left]' ).get();
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[content_right]' ) !== 'undefined' ) {
				contentRight = wp.customize( 'aureon_spacing_settings[content_right]' ).get();
			}
		...
		if ( aureon_live_preview.isFlex && 'boxes' === containerAlignment ) {
			...
			if ( typeof wp.customize( 'aureon_spacing_settings[top_bar_left]' ) !== 'undefined' ) {
				topBarPaddingLeft = wp.customize( 'aureon_spacing_settings[top_bar_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[top_bar_right]' ) !== 'undefined' ) {
				topBarPaddingRight = wp.customize( 'aureon_spacing_settings[top_bar_right]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[header_left]' ) !== 'undefined' ) {
				headerPaddingLeft = wp.customize( 'aureon_spacing_settings[header_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[header_right]' ) !== 'undefined' ) {
				headerPaddingRight = wp.customize( 'aureon_spacing_settings[header_right]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[footer_widget_container_left]' ) !== 'undefined' ) {
				footerWidgetPaddingLeft = wp.customize( 'aureon_spacing_settings[footer_widget_container_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[footer_widget_container_right]' ) !== 'undefined' ) {
				footerWidgetPaddingRight = wp.customize( 'aureon_spacing_settings[footer_widget_container_right]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[footer_left]' ) !== 'undefined' ) {
				footerBarPaddingLeft = wp.customize( 'aureon_spacing_settings[footer_left]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[footer_right]' ) !== 'undefined' ) {
				footerBarPaddingRight = wp.customize( 'aureon_spacing_settings[footer_right]' ).get() + 'px';
			}
		...
		if ( aureon_live_preview.isFlex && 'text' === containerAlignment ) {
			...
			if ( typeof wp.customize( 'aureon_spacing_settings[menu_item]' ) !== 'undefined' ) {
				menuItemPadding = wp.customize( 'aureon_spacing_settings[menu_item]' ).get() + 'px';
			}

			if ( typeof wp.customize( 'aureon_spacing_settings[secondary_menu_item]' ) !== 'undefined' ) {
				secondaryMenuItemPadding = wp.customize( 'aureon_spacing_settings[secondary_menu_item]' ).get() + 'px';
			}
	...
	wp.customize( 'aureon_settings[global_colors]', function( value ) {
		value.bind( function( newval ) {
			var globalColors = '';
