...
Aureon_Customize_Field::add_title(
	'aureon_buttons_colors_title',
	array(
		'section' => 'aureon_colors_section',
		'title' => __( 'Buttons', 'aureon' ),
		'choices' => array(
...
Aureon_Customize_Field::add_wrapper(
	'aureon_buttons_background_wrapper',
	array(
		'section' => 'aureon_colors_section',
		'choices' => array(
			'type' => 'color',
...
if ( defined( 'AUREON_STUDIO_VERSION' ) && version_compare( AUREON_STUDIO_VERSION, '2.4.1', '>' ) ) {
