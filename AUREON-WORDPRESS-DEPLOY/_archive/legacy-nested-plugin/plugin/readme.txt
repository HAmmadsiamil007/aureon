...
Take Aureon to the next level.

== Description ==

The entire collection of Aureon premium modules. Once activated, each module extends certain aspects of Aureon, giving you more options to build your website.

= Documentation =

Check out our [documentation](https://docs.aureonstudio.com) for more information on each module and how to use them.

== Installation ==

To learn how to install Aureon Studio, check out our documentation [here](https://docs.aureonstudio.com/article/installing-aureon-studio/).
...
* Feature: Add `aureon_smooth_scroll_offset` filter
...
* Menu Plus: Integrate mobile header and off-canvas panel with new aureon_has_active_menu filter
...
* Secondary Navigation: Integrate with new aureon_has_active_menu filter
...
* Elements: Add aureon_element_display filter
...
* WooCommerce: Add aureon_wc_cart_panel_checkout_button_output filter
* WooCommerce: Add aureon_wc_sticky_add_to_cart_action filter
* WooCommerce: Add aureon_wc_show_sticky_add_to_cart filter
...
* General: Update aureon-studio-de_DE.mo
* General: Update aureon-studio-es_ES.mo
* General: Update aureon-studio-fi.mo
* General: Update aureon-studio-pt_PT.mo
* General: Update aureon-studio-sv_SE.mo
...
* Elements: Prevent error in editor when aureon_get_option() function doesn't exist
...
* Blog: Add aureon_blog_masonry_init filter
* Blog: Add aureon_blog_infinite_scroll_init filter
...
* Disable Elements: Use aureon_show_post_navigation filter to disable single post navigation
* Elements: Use full hook name with aureon_ prefix in dropdown
* Elements: Rebuild how Element types are chosen
* Elements: Add chosen hook under type column in edit.php
* Menu Plus: Add aureon_after_mobile_header_menu_button filter
...
* Secondary Nav: Add aureon_after_secondary_navigation hook
* Secondary Nav: Add aureon_before_secondary_navigation hook
...
* Secondary Nav: Add aureon_secondary_menu_bar_items hook
* Spacing: Set sidebar width in Customizer for future flexbox option
* WooCommerce: Add aureon_woocommerce_show_add_to_cart_panel filter
...
* Elements: Add aureon_elements_admin_menu_capability filter
* Elements: Add aureon_page_hero_css_output filter
...
* Elements: Add aureon_inside_site_container hook option
* Elements: Add aureon_after_entry_content hook option
* Menu Plus: Add off canvas desktop toggle label option
* Menu Plus: Add aureon_off_canvas_toggle_output filter
...
* Typography: Only call aureon_get_all_google_fonts if needed
...
* General: Use aureon_premium_get_media_query throughout modules
...
* Menu Plus: Set aureon_not_mobile_menu_media_query filter based on mobile menu breakpoint
* Sections: Remember when text tab is active
* Sections: Disable visual editor if turned off in profile
* Typography: Add aureon_google_font_display filter
...
* Typography: Remove reference to aureon_get_navigation_location() function
...
* Elements: Add aureon_page_hero_location filter
* Elements: Add aureon_elements_show_object_ids filter to show IDs in Display Rule values
...
* Elements: Add aureon_mobile_cart_items hook to hook list
* Elements: Add aureon_element_post_id filter
...
* Add aureon_disable_customizer_shortcuts filter
