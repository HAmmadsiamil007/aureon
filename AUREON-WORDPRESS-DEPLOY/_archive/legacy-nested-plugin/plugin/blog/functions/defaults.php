...
if ( ! function_exists( 'aureon_blog_get_defaults' ) ) {
	 ...
	 * @since 0.1
	 */
	function aureon_blog_get_defaults() {
		$aureon_blog_defaults = array(
			'excerpt_length' => '55',
			'read_more' => __( 'Read more', 'aureon-studio' ),
			'read_more_button' => false,
			'masonry' => false,
			'masonry_load_more' => __( '+ More', 'aureon-studio' ),
			'masonry_loading' => __( 'Loading...', 'aureon-studio' ),
		...
		return apply_filters( 'aureon_blog_option_defaults', $aureon_blog_defaults );
	}
}
