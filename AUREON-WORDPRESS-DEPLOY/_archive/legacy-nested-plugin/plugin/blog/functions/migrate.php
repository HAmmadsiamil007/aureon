...
add_action( 'admin_init', 'aureon_blog_update_visibility_settings' );
/**
 * Migrates our old Blog settings so we can use checkboxes instead.
 *
 * @since 1.5
 */
function aureon_blog_update_visibility_settings() {
	...
	update_option( 'aureon_blog_settings', $update_settings );
