...
add_action( 'customize_register', 'aureon_slideout_typography_customizer', 150 );
/**
 * Adds our WooCommerce color options
 */
function aureon_slideout_typography_customizer( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Aureon_Section_Shortcut_Control(
			$wp_customize,
			'aureon_off_canvas_panel_typography_shortcuts',
			array(
				'section' => 'aureon_slideout_typography',
				'element' => esc_html__( 'Off Canvas Panel', 'aureon-studio' ),
				'shortcuts' => array(
	...
	$wp_customize->add_setting(
		'aureon_settings[slideout_font_weight]',
		array(
	...
	// Text transform
	$wp_customize->add_setting(
		'aureon_settings[slideout_font_transform]',
		array(
	...
	$wp_customize->add_control(
		new Aureon_Pro_Typography_Customize_Control(
			...
			array(
				'label' => esc_html__( 'Menu Items', 'aureon-studio' ),
				'section' => 'aureon_slideout_typography',
				'settings' => array(
					'weight' => 'aureon_settings[slideout_font_weight]',
					'transform' => 'aureon_settings[slideout_font_transform]',
				),
			)
		)
	);
	...
	// Font size
	$wp_customize->add_setting(
		'aureon_settings[slideout_font_size]',
		array(
	...
	$wp_customize->add_setting(
		'aureon_settings[slideout_mobile_font_size]',
		array(
	...
	$wp_customize->add_control(
		new Aureon_Pro_Range_Slider_Control(
			...
			array(
				...
				'section' => 'aureon_slideout_typography',
				'settings' => array(
					'desktop' => 'aureon_settings[slideout_font_size]',
					'mobile' => 'aureon_settings[slideout_mobile_font_size]',
				),
				'choices' => array(
					'desktop' => array(
						'min' => 10,
