...
add_action( 'wp_enqueue_scripts', 'aureon_enqueue_premium_icons' );
/**
 * Register our Aureon Studio icons.
 *
 * @since 1.6
 */
function aureon_enqueue_premium_icons() {
	$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';

	wp_register_style( 'aureon-studio-icons', plugin_dir_url( __FILE__ ) . "icons/icons{$suffix}.css", array(), AUREON_STUDIO_VERSION );
}

add_filter( 'aureon_svg_icon', 'aureon_premium_add_svg_icons', 10, 2 );
/**
 ...
 */
function aureon_premium_add_svg_icons( $output, $icon ) {
	$svg = '';
