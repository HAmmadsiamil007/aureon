...
if ( ! function_exists( 'aureon_mobile_header_activated' ) ) {
	/**
	 * Check to see if the mobile header is activated
	 */
	function aureon_mobile_header_activated() {
		...
		return ( 'enable' == $aureon_menu_plus_settings[ 'mobile_header' ] ) ? true : false;
	}
}
 ...
 * @since 1.8
 */
function aureon_mobile_header_logo_active_callback() {
	if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
		return false;
	}
...
if ( ! function_exists( 'aureon_mobile_header_sticky_activated' ) ) {
	/**
	 * Check to see if the mobile header is activated
	 */
	function aureon_mobile_header_sticky_activated() {
		if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
			return false;
		}
		...
		return ( 'enable' == $aureon_menu_plus_settings[ 'mobile_header' ] && 'enable' == $aureon_menu_plus_settings[ 'mobile_header_sticky' ] ) ? true : false;
	}
}

if ( ! function_exists( 'aureon_sticky_navigation_activated' ) ) {
	/**
	 * Check to see if the sticky navigation is activated
	 */
	function aureon_sticky_navigation_activated() {
		if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
			return false;
		}
		...
		return ( 'false' !== $aureon_menu_plus_settings[ 'sticky_menu' ] ) ? true : false;
	}
}

if ( ! function_exists( 'aureon_navigation_logo_activated' ) ) {
	/**
	 * Check to see if the sticky navigation is activated
	 */
	function aureon_navigation_logo_activated() {
		if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
			return false;
		}
		...
		return ( '' !== $aureon_menu_plus_settings[ 'sticky_menu_logo' ] ) ? true : false;
	}
}

if ( ! function_exists( 'aureon_slideout_navigation_activated' ) ) {
	/**
	 * Check to see if the sticky navigation is activated
	 */
	function aureon_slideout_navigation_activated() {
		if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
			return false;
		}
		...
		return ( 'false' !== $aureon_menu_plus_settings[ 'slideout_menu' ] ) ? true : false;
	}
}
 ...
 * @since 1.8
 */
function aureon_is_overlay_navigation_active_callback() {
	if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
		return false;
	}
 ...
 * @since 1.8
 */
function aureon_is_slideout_navigation_active_callback() {
	if ( ! function_exists( 'aureon_menu_plus_get_defaults' ) ) {
		return false;
	}
...
if ( ! function_exists( 'aureon_page_header_blog_content_exists' ) ) {
	/**
	 * This is an active_callback
	 * Check if page header content exists
	 */
	function aureon_page_header_blog_content_exists() {
		if ( ! function_exists( 'aureon_page_header_get_defaults' ) ) {
			return false;
		}

		$options = get_option( 'aureon_page_header_options', aureon_page_header_get_defaults() );
...
if ( ! function_exists( 'aureon_page_header_blog_image_exists' ) ) {
	/**
	 * This is an active_callback
	 * Check if page header image exists
	 */
	function aureon_page_header_blog_image_exists() {
		if ( ! function_exists( 'aureon_page_header_get_defaults' ) ) {
			return false;
		}
...
if ( ! function_exists( 'aureon_page_header_blog_crop_exists' ) ) {
	/**
	 * This is an active_callback
	 * Check if page header image resizing is enabled
	 */
	function aureon_page_header_blog_crop_exists() {
		if ( ! function_exists( 'aureon_page_header_get_defaults' ) ) {
			return false;
		}
...
if ( ! function_exists( 'aureon_page_header_blog_combined' ) ) {
	/**
	 * This is an active_callback
	 * Check if page header is merged
	 */
	function aureon_page_header_blog_combined() {
		if ( ! function_exists( 'aureon_page_header_get_defaults' ) ) {
			return false;
		}
...
if ( ! function_exists( 'aureon_page_header_full_screen_vertical' ) ) {
	/**
	 * This is an active_callback
	 * Check if our page header is full screen and vertically centered
	 */
	function aureon_page_header_full_screen_vertical() {
		if ( ! function_exists( 'aureon_page_header_get_defaults' ) ) {
			return false;
		}
...
if ( ! function_exists( 'aureon_secondary_nav_show_merge_top_bar' ) ) {
	/**
	 * This is an active callback
	 * Determines whether we should show the Merge with Secondary Navigation option
	 */
	function aureon_secondary_nav_show_merge_top_bar() {
...
if ( ! function_exists( 'aureon_masonry_callback' ) ) {
	...
	function aureon_masonry_callback() {
		...
		return ( 'true' == $aureon_blog_settings['masonry'] ) ? true : false;

	}
}

if ( ! function_exists( 'aureon_premium_is_posts_page' ) ) {
	/**
	 * Check to see if we're on a posts page
	 */
	function aureon_premium_is_posts_page() {
...
if ( ! function_exists( 'aureon_premium_is_posts_page_single' ) ) {
	/**
	 * Check to see if we're on a posts page or a single post
	 */
	function aureon_premium_is_posts_page_single() {
...
if ( ! function_exists( 'aureon_premium_is_excerpt' ) ) {
	/**
	 * Check to see if we're displaying excerpts
	 */
	function aureon_premium_is_excerpt() {
		...
		return ( 'excerpt' == $aureon_settings['post_content'] ) ? true : false;
	}
}
 ...
 */
function aureon_premium_featured_image_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 */
function aureon_premium_single_featured_image_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 * @return bool Whether featured images on single posts are active or not.
 */
function aureon_premium_single_page_featured_image_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 */
function aureon_premium_blog_columns_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 */
function aureon_premium_blog_masonry_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 * @return bool
 */
function aureon_premium_display_image_padding() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 * @return bool
 */
function aureon_premium_display_image_padding_single() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 * @return bool
 */
function aureon_premium_display_image_padding_single_page() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 * @return bool
 */
function aureon_premium_infinite_scroll_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 * @return bool
 */
function aureon_premium_infinite_scroll_button_active() {
	$settings = wp_parse_args(
		get_option( 'aureon_blog_settings', array() ),
		aureon_blog_get_defaults()
	);
 ...
 */
function aureon_premium_wc_menu_item_active() {
	if ( ! function_exists( 'aureon_wc_defaults' ) ) {
		return false;
	}
 ...
 * @since 1.11.0
 */
function aureon_is_using_external_css_file_callback() {
	if ( ! function_exists( 'aureon_get_option' ) ) {
		return false;
	}

	if ( 'file' === aureon_get_option( 'css_print_method' ) ) {
		return true;
	}
