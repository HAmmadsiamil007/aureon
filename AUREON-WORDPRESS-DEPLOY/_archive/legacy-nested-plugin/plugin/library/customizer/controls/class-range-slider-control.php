...
if ( ! function_exists( 'Aureon_Pro_Range_Slider_Control' ) ) :
class Aureon_Pro_Range_Slider_Control extends WP_Customize_Control {
	/**
	 * The control type.
	 *
	 * @access public
	 * @var string
	 */
	public $type = 'aureon-pro-range-slider';
	...
	public function to_json() {
		...
		$this->json['desktop_label'] = __( 'Desktop', 'aureon-studio' );
		$this->json['tablet_label'] = __( 'Tablet', 'aureon-studio' );
		$this->json['mobile_label'] = __( 'Mobile', 'aureon-studio' );
		$this->json['reset_label'] = __( 'Reset', 'aureon-studio' );
	...
	public function enqueue() {
		wp_enqueue_script( 'aureon-pro-range-slider', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'js/slider-customizer.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), AUREON_STUDIO_VERSION, true );
		wp_enqueue_style( 'aureon-pro-range-slider-css', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'css/slider-customizer.css', AUREON_STUDIO_VERSION );
	}
	/**
	...
	protected function content_template() {
		?>
		<div class="aureon-range-slider-control">
			<div class="aureon-range-title-area">
				<# if ( data.label || data.description ) { #>
					<div class="aureon-range-title-info">
						<# if ( data.label ) { #>
				...
				<div class="aureon-range-slider-controls">
					...
					<span title="{{ data.reset_label }}" class="aureon-reset dashicons dashicons-image-rotate"></span>
				</div>
			</div>

			<div class="aureon-range-slider-areas">
				<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
					<label class="range-option-area" data-option="desktop" style="display: none;">
						<div class="wrapper <# if ( '' !== data.choices['desktop']['unit'] ) { #>has-unit<# } #>">
							<div class="aureon-slider" data-step="{{ data.choices['desktop']['step'] }}" data-min="{{ data.choices['desktop']['min'] }}" data-max="{{ data.choices['desktop']['max'] }}"></div>

							<div class="aureon_range_value <# if ( '' == data.choices['desktop']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
				...
				<# if ( 'undefined' !== typeof ( data.tablet ) ) { #>
					<label class="range-option-area" data-option="tablet" style="display:none">
						<div class="wrapper <# if ( '' !== data.choices['tablet']['unit'] ) { #>has-unit<# } #>">
							<div class="aureon-slider" data-step="{{ data.choices['tablet']['step'] }}" data-min="{{ data.choices['tablet']['min'] }}" data-max="{{ data.choices['tablet']['max'] }}"></div>

							<div class="aureon_range_value <# if ( '' == data.choices['tablet']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
				...
				<# if ( 'undefined' !== typeof ( data.mobile ) ) { #>
					<label class="range-option-area" data-option="mobile" style="display:none;">
						<div class="wrapper <# if ( '' !== data.choices['mobile']['unit'] ) { #>has-unit<# } #>">
							<div class="aureon-slider" data-step="{{ data.choices['mobile']['step'] }}" data-min="{{ data.choices['mobile']['min'] }}" data-max="{{ data.choices['mobile']['max'] }}"></div>

							<div class="aureon_range_value <# if ( '' == data.choices['mobile']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
