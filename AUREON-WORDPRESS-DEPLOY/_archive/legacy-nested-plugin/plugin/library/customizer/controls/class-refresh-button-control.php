...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Aureon_Refresh_Button_Customize_Control' ) ) :
/**
 * Add a button to initiate refresh when changing featured image sizes
 */
class Aureon_Refresh_Button_Customize_Control extends WP_Customize_Control {
