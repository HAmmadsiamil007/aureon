...
if ( ! class_exists( 'Aureon_Alpha_Color_Customize_Control' ) ) :
class Aureon_Alpha_Color_Customize_Control extends WP_Customize_Control {
	/**
	 * Official control name.
	 */
	public $type = 'aureon-alpha-color';
	/**
	...
	public function content_template() {
		...
		<# } #>
		<input class="aureon-alpha-color-control" type="text" data-palette="{{{ data.palette }}}" data-default-color="{{ data.defaultValue }}" {{{ data.link }}} />
		<?php
	}
}
endif;