 ...
 *
 * @package Aureon/Extend/DynamicTags
 */
...
/**
 * Aureon Pro adjacted post dynamic tags.
 *
 * @since 1.4.0
 */
class Aureon_Pro_Dynamic_Tags_Adjacent_Posts extends Aureon_Pro_Singleton {
	/**
	 * Init.
	 */
	...
	public function enqueue_scripts() {
		$editor_assets = aureon_premium_get_enqueue_assets( 'adjacent-posts' );

		wp_enqueue_script(
			'aureon-pro-adjacent-posts',
			AUREON_STUDIO_DIR_URL . 'dist/adjacent-posts.js',
...
Aureon_Pro_Dynamic_Tags_Adjacent_Posts::get_instance()->init();
