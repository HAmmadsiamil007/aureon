 ...
 *
 * @package Aureon_Pro\Dynamic_Tags
 */
 ...
 * @since 2.0.0
 */
class Aureon_Pro_Dynamic_Tags_Register extends Aureon_Pro_Singleton {
	/**
	...
	public function register() {
		...
		new GenerateBlocks_Register_Dynamic_Tag(
			[
				'title'       => __( 'Archive Title', 'aureon-studio' ),
				'tag'         => 'archive_title',
				'type'        => 'archive',
				'supports'    => [],
				'description' => __( 'Get the title for the current archive being viewed.', 'aureon-studio' ),
		...
		new GenerateBlocks_Register_Dynamic_Tag(
			[
				'title'       => __( 'Archive Description', 'aureon-studio' ),
				'tag'         => 'archive_description',
				'type'        => 'archive',
				'supports'    => [],
				'description' => __( 'Get the description for the current archive being viewed.', 'aureon-studio' ),
		...
		new GenerateBlocks_Register_Dynamic_Tag(
			[
				'title'       => __( 'Term Meta', 'aureon-studio' ),
				'tag'         => 'term_meta',
				'type'        => 'term',
				'supports'    => [ 'meta', 'source' ],
				'description' => __( 'Access term meta by key for the specified term. Return value must be a string.', 'aureon-studio' ),
		...
		new GenerateBlocks_Register_Dynamic_Tag(
			[
				'title'    => __( 'Current year', 'aureon-studio' ),
				'tag'      => 'current_year',
				'type'     => 'site',
				'supports' => [],
		...
		new GenerateBlocks_Register_Dynamic_Tag(
			[
				'title'    => __( 'Previous Posts URL', 'aureon-studio' ),
		...
		new GenerateBlocks_Register_Dynamic_Tag(
			[
				'title'    => __( 'Next Posts URL', 'aureon-studio' ),
...
Aureon_Pro_Dynamic_Tags_Register::get_instance()->init();
