wp.customize.controlConstructor['aureon-range-slider'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		var control = this,
		    ...
		    inputDefault,
		    changeAction,
			controlClass = '.customize-control-aureon-range-slider',
		...
		jQuery( controlClass + ' .aureon-reset' ).on( 'click', function() {
			var icon = jQuery( this ),
				visible_area = icon.closest( '.aureon-range-title-area' ).next( '.aureon-range-slider-areas' ).children( 'label:visible' ),
				input = visible_area.find( 'input[type=number]' ),
				slider_value = visible_area.find( '.aureon-slider' ),
				visual_value = visible_area.find( '.aureon_range_value' ),
