...
// Hide when a complete-page design is active — the client's frozen HTML
// handles all presentation; AETHER visual controls would override it.
	...
	$wp_customize->add_section(
		...
		array(
			...
			'active_callback' => function() {
				return function_exists( 'aether_is_complete_page_design' ) && ! aether_is_complete_page_design();
			},
		)
	);
}
