 ...
 * Class Aureon_Rest
 */
class Aureon_Rest extends WP_REST_Controller {
	/**
	 * Instance.
	 *
	 * @access private
	...
	public function reset( WP_REST_Request $request ) {
		...
		return $this->success( __( 'Settings reset.', 'aureon' ) );
	}
