...
if ( ! function_exists( 'aureon_get_defaults' ) ) {
	 ...
	 * @since 0.1
	 */
	function aureon_get_defaults() {
		return apply_filters(
			'aureon_option_defaults',
			array(
				'hide_title' => '',
				'hide_tagline' => true,
				'logo' => '',
				...
				'global_colors' => array(
					array(
						'name' => __( 'Contrast', 'aureon' ),
						'slug' => 'contrast',
						'color' => '#222222',
					),
					array(
						/* translators: Contrast number */
						'name' => sprintf( __( 'Contrast %s', 'aureon' ), '2' ),
						'slug' => 'contrast-2',
						'color' => '#575760',
					),
					array(
						/* translators: Contrast number */
						'name' => sprintf( __( 'Contrast %s', 'aureon' ), '3' ),
						'slug' => 'contrast-3',
						'color' => '#b2b2be',
					),
					array(
					...
					array(
						...
						'name' => sprintf( __( 'Base %s', 'aureon' ), '2' ),
						'slug' => 'base-2',
						'color' => '#f7f8f9',
					),
					array(
						/* translators: Base number */
						'name' => sprintf( __( 'Base %s', 'aureon' ), '3' ),
						'slug' => 'base-3',
						'color' => '#ffffff',
					),
					array(
						'name' => __( 'Accent', 'aureon' ),
						'slug' => 'accent',
						'color' => '#1e73be',
					),
				),
...
if ( ! function_exists( 'aureon_get_color_defaults' ) ) {
	 ...
	 * Set default options
	 */
	function aureon_get_color_defaults() {
		return apply_filters(
			'aureon_color_option_defaults',
			array(
...
if ( ! function_exists( 'aureon_get_default_fonts' ) ) {
	 ...
	 */
	function aureon_get_default_fonts( $filter = true ) {
		$defaults = array(
		...
		if ( $filter ) {
			return apply_filters( 'aureon_font_option_defaults', $defaults );
		}
...
if ( ! function_exists( 'aureon_spacing_get_defaults' ) ) {
	 ...
	 * @return array Option defaults.
	 */
	function aureon_spacing_get_defaults( $filter = true ) {
		$defaults = array(
			'top_bar_top' => '10',
			'top_bar_right' => '40',
			'top_bar_bottom' => '10',
		...
		if ( $filter ) {
			return apply_filters( 'aureon_spacing_option_defaults', $defaults );
		}
