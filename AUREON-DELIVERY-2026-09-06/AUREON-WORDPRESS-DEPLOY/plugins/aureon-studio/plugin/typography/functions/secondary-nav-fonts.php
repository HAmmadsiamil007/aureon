...
if ( ! function_exists( 'aureon_fonts_secondary_nav_customizer' ) ) {
	add_action( 'customize_register', 'aureon_fonts_secondary_nav_customizer', 1000 );
	/**
	 ...
	 */
	function aureon_fonts_secondary_nav_customizer( $wp_customize ) {
		...
		$wp_customize->add_control(
			new Aureon_Section_Shortcut_Control(
				$wp_customize,
				'aureon_secondary_navigation_typography_shortcuts',
				array(
		...
		$wp_customize->add_setting(
			'aureon_secondary_nav_settings[font_secondary_navigation]',
			array(
		...
		// Font weight
		$wp_customize->add_setting(
			'aureon_secondary_nav_settings[secondary_navigation_font_weight]',
			array(
		...
		// Font transform
		$wp_customize->add_setting(
			'aureon_secondary_nav_settings[secondary_navigation_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Aureon_Pro_Typography_Customize_Control(
				...
				array(
					'section' => 'secondary_font_section',
					'settings' => array(
						'family' => 'aureon_secondary_nav_settings[font_secondary_navigation]',
						'variant' => 'font_secondary_navigation_variants',
						'category' => 'font_secondary_navigation_category',
						'weight' => 'aureon_secondary_nav_settings[secondary_navigation_font_weight]',
						'transform' => 'aureon_secondary_nav_settings[secondary_navigation_font_transform]',
					),
				)
			)
		);
		...
		// Font size
		$wp_customize->add_setting(
			'aureon_secondary_nav_settings[secondary_navigation_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Aureon_Pro_Range_Slider_Control(
				...
				array(
					...
					'priority' => 165,
					'settings' => array(
						'desktop' => 'aureon_secondary_nav_settings[secondary_navigation_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
