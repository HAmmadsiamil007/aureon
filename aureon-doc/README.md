...
| [`../docs/TEMPLATE_REQUIREMENTS_FOR_CORE_THEME.md`](../docs/TEMPLATE_REQUIREMENTS_FOR_CORE_THEME.md) | **Complete guide for creating templates** — feature map, architecture, connection points, template types, cloning, creation, data flow, components, sections, assets, tokens, adapters, security, performance, accessibility, testing, deployment, feature integration checklist. |
| [`../docs/FRONTEND_REPLACEMENT_PROMPT.md`](../docs/FRONTEND_REPLACEMENT_PROMPT.md) | **Copy-paste prompt for AI/developer** — architecture overview, step-by-step replacement process, component patterns, data contracts, testing checklist. |
